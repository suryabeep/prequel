...
<script>
  function initFreshChat() {
    window.fcWidget.init({
      token: "a445c7cb-15d7-4586-87be-3e9b4b68ba1a",
...
<header class="header">
            ...
            <div class="header-middle has-center">
                <div class="container">
                    ...
                    <div class="header-right-phone-number">
                        <a href="tel:+1234560789">123.456.0789</a><br> 
                        ...
                        <div class="header-left">
                            <nav class="main-nav">
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)">  Wine Gifts  </a>
                                    </li>
                                    <li>
